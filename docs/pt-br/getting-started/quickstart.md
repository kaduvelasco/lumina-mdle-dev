...
Este guia ajudará você a conectar o `lumina-mdle-dev` ao seu assistente de IA e realizar sua primeira tarefa de desenvolvimento em menos de 5 minutos.
...
```
Inicialize o contexto do lumina-mdle-dev para a instalação em /var/www/html/moodle.
```
