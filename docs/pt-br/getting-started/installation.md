...
O **lumina-mdle-dev** pode ser instalado globalmente via NPM ou clonado localmente para desenvolvimento e contribuição.
...
Após a instalação, o servidor estará disponível via `npx lumina-mdle-dev` ou como executável global.
...
- [Configurar Antigravity CLI](../guides/clients/antigravity.md)
