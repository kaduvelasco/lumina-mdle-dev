# Documentação — Lumina Moodle Developer 🎓

🌐 [English](../../en/index.md) | **Português (BR)** | 🏠 [Voltar para o LEIAME](../../LEIAME.md)

---

O **Lumina Moodle Developer** é um servidor MCP (Model Context Protocol) projetado para expor a estrutura interna do Moodle a assistentes de IA, permitindo um desenvolvimento de plugins mais rápido, seguro e padronizado.
...
- [Por que lumina-mdle-dev?](./concepts/why-lumina-mdle-dev.md) — O problema que o servidor resolve e quando usá-lo.
- [Como o servidor funciona](./concepts/how-lumina-mdle-dev-works.md) — O fluxo entre Extractors, Generators e sua IA.
...
> 💡 **Dica:** Se você estiver usando o Claude Code ou Gemini Code Assist, experimente perguntar diretamente: _"Quais ferramentas o lumina-mdle-dev oferece?"_ — a IA consultará o servidor em tempo real e te responderá com a lista atualizada.
