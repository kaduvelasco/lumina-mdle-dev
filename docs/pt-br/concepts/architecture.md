...
Visão geral dos componentes do `lumina-mdle-dev`, do fluxo de dados e dos modos de operação.
...
- [Como o lumina-mdle-dev funciona](./how-lumina-mdle-dev-works.md) — pipeline completo de Extractors e Generators
