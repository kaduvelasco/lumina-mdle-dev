🌐 [English](../../en/concepts/why-lumina-mdle-dev.md) | **Português (BR)** | 🏠 [Índice](../index.md)

---

# Por que usar o Lumina Moodle Developer?

Assistentes de IA são poderosos — mas sem contexto, eles trabalham no escuro. Este documento explica o problema que o `lumina-mdle-dev` resolve e quando faz sentido usá-lo.
...
O `lumina-mdle-dev` resolve esses problemas expondo a estrutura real da sua instalação Moodle diretamente ao assistente de IA via protocolo MCP.
...
| Situação | Sem lumina-mdle-dev | Com lumina-mdle-dev |
|----------|-------------------|-------------------|
...
O `lumina-mdle-dev` é ideal para:
...
O `lumina-mdle-dev` **não é a ferramenta certa** para:
...
- [Como o lumina-mdle-dev funciona](./how-lumina-mdle-dev-works.md)
