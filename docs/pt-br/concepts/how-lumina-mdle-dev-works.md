🌐 [English](../../en/concepts/how-lumina-mdle-dev-works.md) | **Português (BR)** | 🏠 [Índice](../index.md)

---

# Como o Lumina Moodle Developer funciona

O `lumina-mdle-dev` lê sua instalação Moodle do disco e dá ao seu assistente de IA conhecimento profundo e preciso da sua base de código — sem copiar e colar nada manualmente.
...
- [Por que lumina-mdle-dev?](./why-lumina-mdle-dev.md)
