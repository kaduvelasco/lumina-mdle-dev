...
O `lumina-mdle-dev` gera arquivos Markdown estruturados diretamente na sua instalação Moodle. Esses arquivos servem como uma "ponte de conhecimento" — permitem que o assistente de IA entenda a arquitetura do seu código sem precisar ler milhares de linhas de PHP bruto.
...
- [Como o servidor funciona](../concepts/how-lumina-mdle-dev-works.md) — pipeline de Extractors e Generators
