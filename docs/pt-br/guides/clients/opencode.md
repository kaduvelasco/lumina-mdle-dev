...
```json
{
  ...
  "mcp": {
    "lumina-mdle-dev": {
      "type": "local",
      "command": ["/home/usuario/.nvm/versions/node/v22.0.0/bin/npx", "-y", "lumina-mdle-dev"],
      "environment": {
        "MOODLE_PATH": "/home/usuario/workspace/www/html/moodle"
      }
    }
...
Dentro da sessão, verifique se o servidor está conectado — o `lumina-mdle-dev` deve aparecer na lista de servidores MCP ativos.
