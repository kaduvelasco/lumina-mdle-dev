...
```json
{
  ...
  "mcp": {
    "lumina-mdle-dev": {
      "type": "local",
      "command": ["/home/user/.nvm/versions/node/v22.0.0/bin/npx", "-y", "lumina-mdle-dev"],
      "environment": {
        "MOODLE_PATH": "/home/user/workspace/www/html/moodle"
      }
    }
...
Inside the session, verify the server is connected — `lumina-mdle-dev` should appear in the list of active MCP servers.
