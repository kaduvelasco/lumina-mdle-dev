...
**lumina-mdle-dev** can be installed globally via NPM or cloned locally for development and contribution.
...
After installation, the server will be available via `npx lumina-mdle-dev` or as a global executable.
