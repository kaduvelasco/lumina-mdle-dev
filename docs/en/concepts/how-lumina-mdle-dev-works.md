🌐 [Português](../../pt-br/concepts/how-lumina-mdle-dev-works.md) | **English** | 🏠 [Index](../index.md)

---

# How Lumina Moodle Developer works

`lumina-mdle-dev` reads your Moodle installation from disk and gives your AI assistant deep and accurate knowledge of your codebase — without copying and pasting anything manually.
...
- [Why lumina-mdle-dev?](./why-lumina-mdle-dev.md)
