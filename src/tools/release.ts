...
const EXCLUDED_NAMES = new Set([
  // lumina-mdle-dev generated context docs
...
export function registerReleaseTool(server: McpServer): void {
  server.tool(
    ...
    "Also excludes: lumina-mdle-dev generated files (PLUGIN_*.md), AI context files " +
    "(CLAUDE.md, GEMINI.md, AGENTS.md), AI tool config files (.claudeignore, " +
    ".geminiignore, .aiexclude), development markers (.indevelopment), " +
